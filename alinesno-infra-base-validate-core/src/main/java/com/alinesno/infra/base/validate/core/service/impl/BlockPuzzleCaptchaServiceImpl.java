...
import com.alinesno.infra.base.validate.core.model.common.RepCodeEnum;
import com.alinesno.infra.base.validate.core.model.common.ResponseModel;
import com.alinesno.infra.base.validate.core.model.vo.CaptchaVO;
import com.alinesno.infra.base.validate.core.model.vo.PointVO;
import com.alinesno.infra.base.validate.core.service.CaptchaCacheService;
import com.alinesno.infra.base.validate.core.util.*;
...
//            base64StrToImage(encoder.encodeToString(jigsawImages), "D:\\滑动.png");
            ...
            CaptchaCacheService ccs = CaptchaServiceFactory.getCache(cacheType);
            ccs .set(codeKey, JsonUtil.toJSONString(point), EXPIRESIN_SECONDS);
